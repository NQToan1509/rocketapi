...
var DDPDriver = /** @class */ (function (_super) {
    ...
    function DDPDriver(_a) {
        ...
        _this.onMentorAccept = function (menthod,cb) {
            var args = [];
            for (var _i = 1; _i < arguments.length; _i++) {
                args[_i - 1] = arguments[_i];
            }
            ...
            return cb( Promise.resolve( _this.ddp.call.apply(_a, __spread([method], args)))
                .then(function () { return ({
                stop: function () { return _this.ddp.off.apply(_a, __spread([method], args))}
            }); }))
