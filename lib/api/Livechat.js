...
var ApiLivechat = /** @class */ (function (_super) {
    ...
    ApiLivechat.prototype.student = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_b) {
            return [2 /*return*/, this.get("livechat/student/"+ email + "/" + this.credentials.token)];
        }); });
    };

    ApiLivechat.prototype.findMentor = function (params) {
        
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_b) {
            return [2 /*return*/, this.post("livechat/startFindMentor",{ token: this.credentials.token,departmentId:params.departmentId,rid:params.rid })];
        }); });
    };
