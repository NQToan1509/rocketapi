...
var ApiLivechat = /** @class */ (function (_super) {
    ...
    ApiLivechat.prototype.agent = function (_a) {
     ...
     ApiLivechat.prototype.historyStudent = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0: return [4 /*yield*/, this.get("livechat/getLivechatandHanging", __assign({ token: this.credentials.token }, params), false)];
                case 1: return [2 /*return*/, (_a.sent()).data];
            }
        }) })
     };
    ApiLivechat.prototype.rate = function (data) { return (this.post('livechat/rate', { data, token: this.credentials.token}, false)); };
